...
def load_wadi_data():
    z_tr = zipfile.ZipFile('../datasets/SETD/SETD_train.zip', "r")
    f_tr = z_tr.open(z_tr.namelist()[0])
    train_df=pd.read_csv(f_tr)
    f_tr.close()
    z_tr.close()
    
    z_tr = zipfile.ZipFile('../datasets/SETD/SETD_test.zip', "r")
    f_tr = z_tr.open(z_tr.namelist()[0])
...
def load_swat_data():
    z_tr = zipfile.ZipFile('../datasets/JDGC/JDGC_train.zip', "r")
    f_tr = z_tr.open(z_tr.namelist()[0])
    train_df=pd.read_csv(f_tr)
    f_tr.close()
    z_tr.close()
    
    z_tr = zipfile.ZipFile('../datasets/JDGC/JDGC_test.zip', "r")
    f_tr = z_tr.open(z_tr.namelist()[0])
    test_df=pd.read_csv(f_tr)
    f_tr.close()
    z_tr.close()
...
def load_pump_data():
    ...
    z_tr = zipfile.ZipFile('../datasets/GNRA/GNRA_train.zip', "r")
    f_tr = z_tr.open(z_tr.namelist()[0])
    train_df=pd.read_csv(f_tr)
    f_tr.close()
    z_tr.close()
    
    z_tr = zipfile.ZipFile('../datasets/GNRA/GNRA_test.zip', "r")
    f_tr = z_tr.open(z_tr.namelist()[0])
    test_df=pd.read_csv(f_tr)
    f_tr.close()
    z_tr.close()
